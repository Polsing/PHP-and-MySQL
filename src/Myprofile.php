...
<div class="container">
  <div class="products-con">
    ...
    <div class="products-item name">
      ...
      <br>
      <h4>คณะ  <?php echo $rows['faculty_name'];?></h4>
      <h4>สาขา <?php echo $rows['branch_name'];?></h4>
      <h4><?php echo $rows['years'];?></h4>
    ...
    <div class="products-item follow-me">
      ...
      <?php 
        ...
        if(strlen($fll['facebookURL'] <= 0))
        $facebookURL = "#";
        else
        $facebookURL = $fll['facebookURL'];
      ?>
        <a href="<?php echo $facebookURL;?>"><?php echo $facebook;?></a>
      </div>
      ...
      <?php 
        ...
        if(strlen($fll['instagramURL'] <= 0))
        $instagramURL = "#";
        else
        $instagramURL = $fll['instagramURL'];
      ?>
        <a href="<?php echo $instagramURL;?>"><?php echo $instagram;?></a>
      </div>
      ...
      <?php 
        ...
        $youtube = $fll['youtube'];
        if(strlen($fll['youtubeURL'] <= 0))
        $youtubeURL = "#";
        else
        $youtubeURL = $fll['youtubeURL'];
      ?>
        <a href="<?php echo $youtubeURL;?>"><?php echo $youtube;?></a>
      </div>
      ...
      <?php 
        ...
        $twitter = $fll['twitter'];
        if(strlen($fll['twitterURL'] <= 0))
        $twitterURL = "#";
        else
        $twitterURL = $fll['twitterURL'];
      ?>
      ...
      <?php 
        ...
        $tiktok = $fll['tiktok'];
        if(strlen($fll['tiktokURL'] <= 0))
        $tiktokURL = "#";
        else
        $tiktokURL = $fll['tiktokURL'];
      ?>
        <a href="<?php echo $tiktokURL;?>"><?php echo $tiktok;?></a>
      </div>
      ...
      <?php 
        ...
        $github = $fll['github'];
        if(strlen($fll['githubURL'] <= 0))
        $githubURL = "#";
        else
        $githubURL = $fll['githubURL'];
      ?>
        <a href="<?php echo $githubURL;?>"><?php echo $github;?></a>
      </div>
    </div>
